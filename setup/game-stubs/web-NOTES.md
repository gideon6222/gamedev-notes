...
(From PLAN.md "Open decisions I made for him", then anything decided during the build. One
line each with the alternative, so he can reverse it.)
...
|---|---|---|---|
| {{DATE}} | Fresh copy of the template | tests and smoke green | `npm test && npm run e2e` |
